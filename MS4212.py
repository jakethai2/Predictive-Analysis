...
plt.plot(train_range, label="Training Data (Actual)", color="blue")
plt.plot(validation_range, label="Validation Data (Actual)", color="orange")
plt.plot(test_range, label="Test Data (Actual)", color="green")
plt.plot(forecast_validation, label="Validation Data (Predicted)", linestyle="--", color="red")
plt.plot(forecast_test, label="Test Data (Predicted)", linestyle="--", color="purple")
plt.xlabel("Date")
plt.ylabel("Fuel Consumption")
plt.title("Fuel Consumption Prediction: Training, Validation, and Testing vs. Actual")
plt.legend()
plt.grid(True)
plt.show()
